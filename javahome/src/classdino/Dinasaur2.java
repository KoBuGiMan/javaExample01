...
class Dino {
	private String dinoList[][] = new String[][] { { "티라노", "벅벅이", "10살", "1동" } };
	String copyDinoList[][];
	String species;
	String name;
	String age;
...
class Employee {
	private String[][] employeeList = new String[][] { { "제이슨", "경비원", "10년" } };
...
class Food {
	...
	private String[][] foodList = new String[dino.copyDinoList.length][6];
	String[][] copyFoodList;
	String spe;
	String weight;
	String name;
